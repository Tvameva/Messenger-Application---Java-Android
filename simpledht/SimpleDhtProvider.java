...
public class SimpleDhtProvider extends ContentProvider {
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        try {
            ...
            if(hashKey.compareTo(hleast)<0){
                ...
                String msgInsert = "MustInsert$" + key + "$" + value;
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        if (selection.equals("@")) {
            ...
            if(localKeys.contains(selection)){
                ...
                //Log.i("Delete Provider","Deletion successful");
            }
    ...
    private class ServerTask extends AsyncTask<ServerSocket, String, Void> {
        ...
        protected Void doInBackground(ServerSocket... sockets) {
            ...
            try {
                while (true) {
                    ...
                    //Log.i("Server Task","trying Split");
                    ...
                    if ("InsertMsg".equals(swich)) {
                        ...
                        //Log.i("Server Task","Calling Insert msg at port "+myPort);
                        MustInsert(m_parts[1], m_parts[2]);
        ...
        public void MustInsert(String key, String value) {
            //Log.i("Insertion Local","Inserting to my node with must insert condition");
            Values.put(key,value);
            inputToFile(key,value);
            localKeys.add(key);
            //insert to content provider
        ...
        public void QueryMsg(String queryKey, String hqKey, String queryRequestFrom){
            if(localKeys.contains(queryKey)){
        ...
        public void Delete(String keyToDelete, String fromPort){
            ...
            if(localKeys.contains(keyToDelete)){
                ...
                String doneDel = "DoneDel";
                new ClientTask().executeOnExecutor(AsyncTask.SERIAL_EXECUTOR,doneDel, fromPort);
                //back=1;
            }
            else {
                //int prev_back = back;
